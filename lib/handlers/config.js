...
function defaultEmailConfig() {
    return {
        ...
        // Lembrete diário pro admin revisar/atualizar a Base de Clientes
        // (roda dentro de api/cron-resumo.js, ver sendLembreteClientes lá)
        // — aviso simples, sempre o mesmo, sem depender de nenhum dado.
