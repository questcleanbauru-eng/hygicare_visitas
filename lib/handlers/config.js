...
function defaultEmailConfig() {
    return {
        ...
        manutencao_label_afericao_vazao: 'Aferição de Vazão',
        manutencao_label_calibracao_manutencao: 'Calibração/Manutenção',
        manutencao_label_atendimento_lavanderia: 'Atendimento ao Cliente — Lavanderia',
