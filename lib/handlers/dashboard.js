...
import { verifyUser, filterByUser, parseDate, isDateWithinLastDays, daysSinceDate, isConfigOn } from '../common.js';
...
export async function handleGetDashboardData(payload) {
    ...
    return withCache('d_' + user.email, 120, async () => {
        ...
        const canAccessRadar = profile === 'admin' || isConfigOn(appConfig.permitir_acesso_radar);
        ...
        return {
            ...
            data: {
                ...
                canDelete: profile === 'admin' || isConfigOn(appConfig.permitir_apagar_outros),
                canCreateProposalFunil: profile === 'admin' || isConfigOn(appConfig.permitir_criar_proposta_funil),
