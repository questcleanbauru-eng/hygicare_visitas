...
const HEADERS = [
    ...
    // Variante "SPSP - Paulo" (ver renderRelatorioTecnicoFormPage no front) —
    // TipoRelatorio fica vazio pro relatório padrão, 'paulo' pra essa
    // variante; as demais só são preenchidas por ela.
    'TipoRelatorio', 'EquipamentoAferido', 'AssinaturaCliente', 'AssinaturaTecnico'
];
...
const TEXT_FIELDS = {
    ...
    tipoRelatorio: 'TipoRelatorio', equipamentoAferido: 'EquipamentoAferido',
    assinaturaCliente: 'AssinaturaCliente', assinaturaTecnico: 'AssinaturaTecnico'
};
