...
// Buffer de .xls antigo (OLE2/BIFF, Excel 97-2003) → mesmo formato de
// tabela acima. Esse formato binário é bem mais complexo que o .xlsx (que é
// só um ZIP de XML) — em vez de reimplementar o parser BIFF na mão, usa a
// SheetJS aqui (só pra esse caminho; .xlsx continua no parser próprio
// acima, já testado). Instalada a partir do cdn.sheetjs.com (não do
// registro do npm) porque a versão publicada lá está com CVE sem correção.
let _XLSX = null;
...
export async function xlsToTable(buf) {
