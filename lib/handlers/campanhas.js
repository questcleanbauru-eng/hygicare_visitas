...
export async function handleGetCampanha(payload) {
    ...
    // Registra o acesso — só quando é o vendedor de verdade abrindo (não
    // quando o admin entra pra conferir), pra "acessou em" refletir o
    // vendedor de fato.
    if (isDono && !isAdminOrGerente(user)) {
