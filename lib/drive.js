...
// Assim os arquivos entram de verdade nas pastas do Drive dessa conta
// (15 GB) e podem ser consultados pelo app e pelo próprio Drive.

const DRIVE_UPLOAD = 'https://www.googleapis.com/upload/drive/v3/files';
const DRIVE_FILES = 'https://www.googleapis.com/drive/v3/files';

// Pastas de destino. Trocáveis por env var (redeploy pega).
